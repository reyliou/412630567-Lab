...
故事設定為：NEO-Corp 因系統遷移留下了多個歷史包袱，而你要做得不是頭鐵進行爆破他們公司的門戶，**你只能試著去理解一件事實，湯匙不存在**。 你該做的是發現網頁上有什麼資訊或特有的機制，有什麼服務，並且檢查網頁的原始碼或無意洩漏資訊HTML，一步一步的在多個環境互相跳躍，最終取得 root 權限並產出學號專屬的 Flag。
